                    ...
                    <div class="col-md-4">
                                <div class="card">
                                    ...
                                    <div class="form-horizontal">
                                        ...
                                        <button type="submit" id="btn_save_tans" class="btn btn-info full-width">Save Invoice</button>
                                            <a href="<?php echo base_url()?>supplier_invoice" type="button" class="btn btn-default float-right">Cancel</a>
