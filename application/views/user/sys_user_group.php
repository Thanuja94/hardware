        ...
        <div class="content-header">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">User Group List &nbsp; &nbsp;
            ...
            <form method="post" action="<?php echo base_url() ?>user/user/add_new_group">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input class="form-control input-rounded" name="user_group" placeholder="Enter User Group"
                            required="" type="text">
                    </div>
                    <!-- <div class="form-group">
                        <li class="fa fa-users">&nbsp;&nbsp;</li>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-radio">
                                <input class="custom-control-input" type="radio" id="customRadio1" name="permission">
                                <label for="customRadio1" class="custom-control-label">Admin</label>
                            </div>

                            <div class="custom-control custom-radio">
                                <input class="custom-control-input" type="radio" id="customRadio2" name="permission">
                                <label for="customRadio2" class="custom-control-label">Normal</label>
                            </div>
                        </div>
